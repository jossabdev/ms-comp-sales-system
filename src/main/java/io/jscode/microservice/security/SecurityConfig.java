	...
	public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
		httpSecurity
		    ...
		    .authorizeHttpRequests((httpRequest) -> httpRequest
		    	   ...
		    	   .requestMatchers(HttpMethod.GET, "/**", "/roles", "/productos/obtenerTodosLosProductosEnStock").hasAnyRole("Administrador", "Vendedor")
		    	   ...
		    	   .requestMatchers(HttpMethod.POST, "/inventarios/guardarInventario", "/categorias/guardarCategoria", "/productos/guardarProducto", "/ventas/anularVenta", "/usuarios/**").hasRole("Administrador")
